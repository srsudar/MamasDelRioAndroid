...
public class Collect extends Application {
  ...
  // Note that if you are building to deploy this, either remove the tracking
  // logic or include google-services.json in the /app/ directory.
  ...
  synchronized public Tracker getDefaultTracker() {
    if (mTracker == null) {
      ...
      // Don't track if we're using debug builds.
