...
//		mShowLocation.setClickable(mMarker != null);
	...
	public void onMapReady(GoogleMap googleMap) {
		// Moved to this async callback to update the play services API. Unclear if
		// this is actually working, as I don't have any geopoint activities to
		// test it with, but it compiles.
		mMap = googleMap;
		if ( mMap == null ) {
			Toast.makeText(getBaseContext(), getString(R.string.google_play_services_error_occured),
					Toast.LENGTH_SHORT).show();
